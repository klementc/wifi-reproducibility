...
########## PARAMETERS ##########
echo "Reproduce Scenario: Single station throughput"

bitRates=44.05 # bitRate in SimGrid in Mbps (obtained from the final plot of ns-3 values)
useNS3=1
local_only=0
name="calibration_section_611"
useDecayModel=0
threshRTSCTS=100
seeds="$(seq 1 1 200)"
radiuses=15 #"5 10 15 30" We tried different radius (lower than 30 meters) with the same conclusions
simTime=70
nSTAInFirstRange=-1
nSTAInSecondRange=-1
radius2=-1

dataSizes=$(seq 10000000 5000000 100000000)
#bitRates=38.13
topos=2
